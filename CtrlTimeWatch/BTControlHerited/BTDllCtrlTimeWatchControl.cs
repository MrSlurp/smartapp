...
{
    internal class BTDllCtrlTimeWatchControl : BTControl
    {
        ...
        /// </summary>
        public BTDllCtrlTimeWatchControl()
        {
            m_IControl = new InteractiveCtrlTimeWatchDllControl();
            if (m_IControl != null)
                m_IControl.SourceBTControl = this;

            m_SpecificProp = new DllCtrlTimeWatchProp();
        }

        /// <summary>
        /// Constructeur de la à partir d'un control interactif
        /// </summary>
        public BTDllCtrlTimeWatchControl(InteractiveControl Ctrl)
        {
            m_IControl = Ctrl;
            if (m_IControl != null)
                m_IControl.SourceBTControl = this;

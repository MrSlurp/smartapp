...
namespace CtrlTimeWatch
{
    ...
    public partial class InteractiveCtrlTimeWatchDllControl : InteractiveControl, ISpecificControl
    {
        ...
        /// </summary>
        public InteractiveCtrlTimeWatchDllControl()
        {
        ...
        {
            SizeF SizeText = gr.MeasureString("TimeWatch", SystemFonts.DefaultFont);
            PointF PtText = new PointF(ctrl.ClientRectangle.Left + 2, (ctrl.Height - SizeText.Height) / 2);
            gr.DrawString("TimeWatch", SystemFonts.DefaultFont, Brushes.Black, PtText);
        }

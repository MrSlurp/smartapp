...
@rem
@set DevEnvDir=e:\Program Files\Microsoft Visual Studio 9.0\Common7\IDE
...
@set INCLUDE=e:\Program Files\Microsoft Visual Studio 9.0\VC\INCLUDE;%INCLUDE%
@set LIB=e:\Program Files\Microsoft Visual Studio 9.0\VC\LIB;%LIB%
@set LIBPATH=C:\Windows\Microsoft.NET\Framework\v3.5;C:\Windows\Microsoft.NET\Framework\v2.0.50727;e:\Program Files\Microsoft Visual Studio 9.0\VC\LIB;%LIBPATH%

...
namespace CtrlCnxManager
{
    ...
    public partial class InteractiveCtrlCnxManagerDllControl : InteractiveControl, ISpecificControl
    {
        ...
        /// </summary>
        public InteractiveCtrlCnxManagerDllControl()
        {
            ...
            m_SpecGraphicProp.m_MinSize = new Size(100, 24);
            m_SpecGraphicProp.m_MaxSize = new Size(100, 24);
        ...
        {
            return new InteractiveCtrlCnxManagerDllControl();
        }
        ...
        {
            SizeF SizeText = gr.MeasureString("Connexion Manager", SystemFonts.DefaultFont);
            PointF PtText = new PointF(ctrl.ClientRectangle.Left + 2, (ctrl.Height - SizeText.Height) / 2);
            gr.DrawString("Connexion Manager", SystemFonts.DefaultFont, Brushes.Black, PtText);
        }

...
namespace CtrlCnxManager
{
    public class DllEntryClass : IDllControlInterface
    {
        ...
        public const uint DLL_Control_ID = 280;
        ...
        public string CurrentLang
        {
            ...
            set
            {
                m_CurLang = value;
                if (!LangSys.InitDone)
                    LangSys.Initialize(Cste.STR_DEV_LANG, m_CurLang, "CtrlCnxManager");
                else
        ...
        {
            CtrlCnxManagerRes.InitializeBitmap();
        }

...
{
    internal class BTDllDigitalDisplayControl : BTControl
    {
        protected SpecificControlProp m_SpecificProp = null;

        public BTDllDigitalDisplayControl()
        {
        ...
        public override bool WriteOut(XmlDocument XmlDoc, XmlNode Node)
        {
            ...
            AttrDllId.Value = DigitalDisplay.DllEntryClass.DLL_Control_ID.ToString();

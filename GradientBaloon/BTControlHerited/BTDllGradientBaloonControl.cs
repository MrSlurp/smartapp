...
{
    internal class BTDllGradientBaloonControl : BTControl
    {
        protected SpecificControlProp m_SpecificProp = null;

        public BTDllGradientBaloonControl()
        {
        ...
        public override bool WriteOut(XmlDocument XmlDoc, XmlNode Node)
        {
            ...
            AttrDllId.Value = GradientBaloon.DllEntryClass.DLL_Control_ID.ToString();

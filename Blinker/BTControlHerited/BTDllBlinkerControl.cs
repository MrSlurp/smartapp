...
namespace Blinker
{
    internal class BTDllBlinkerControl : BTControl
    {
        ...
        /// </summary>
        public BTDllBlinkerControl()
        {
            m_IControl = new InteractiveBlinkerDllControl();
            if (m_IControl != null)
                m_IControl.SourceBTControl = this;

            m_SpecificProp = new DllBlinkerProp();
        }

        /// <summary>
        /// Constructeur de la à partir d'un control interactif
        /// </summary>
        public BTDllBlinkerControl(InteractiveControl Ctrl)
        {
            m_IControl = Ctrl;
            if (m_IControl != null)
                m_IControl.SourceBTControl = this;
        ...
        public override uint DllControlID
        {
            get
            {
                return Blinker.DllEntryClass.DLL_Control_ID;
            }
        }

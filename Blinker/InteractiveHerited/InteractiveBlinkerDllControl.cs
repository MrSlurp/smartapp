...
namespace Blinker
{
    ...
    /// </summary>
    public partial class InteractiveBlinkerDllControl : InteractiveControl, ISpecificControl
    {
        // panneau des propriété de l'objet
        UserControl m_SpecificPropPanel = new BlinkerProperties();
        ...
        /// </summary>
        public InteractiveBlinkerDllControl()
        {
            InitializeComponent();

...
namespace Blinker
{
    internal partial class BlinkerProperties : UserControl, ISpecificPanel
    {
        ...
        public BTControl BTControl
        {
            ...
            set
            {
                if (value != null && value.SpecificProp.GetType() == typeof(DllBlinkerProp))
                    m_Control = value;
                else
                    m_Control = null;
                if (m_Control != null)

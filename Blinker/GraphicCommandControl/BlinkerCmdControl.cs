...
namespace Blinker
{
    ...
    /// </summary>
    internal class BlinkerCmdControl : BTDllBlinkerControl
    {
        /// <summary>
        /// Constructeur de la classe
        /// </summary>
        public BlinkerCmdControl()
        {
    ...
    /// - les deux, etc.
    /// </summary>
    public class BlinkerDispCtrl : UserControl
    {
        // ajouter ici les données membres du control affiché

        public BlinkerDispCtrl()
        {
        }

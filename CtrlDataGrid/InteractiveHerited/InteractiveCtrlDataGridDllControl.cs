...
namespace CtrlDataGrid
{
    ...
    public partial class InteractiveCtrlDataGridDllControl : InteractiveControl, ISpecificControl
    {
        ...
        /// </summary>
        public InteractiveCtrlDataGridDllControl()
        {
        ...
        public void SelfPaint(Graphics gr, Control ctrl)
        {
            ...
            {
                dataGridView.Visible = false;
                SizeF SizeText = gr.MeasureString("DataGrid", SystemFonts.DefaultFont);
                PointF PtText = new PointF(ctrl.ClientRectangle.Left + 2, (ctrl.Height - SizeText.Height) / 2);
                gr.DrawString("DataGrid", SystemFonts.DefaultFont, Brushes.Black, PtText);
            }
        }

...
{
    internal class BTDllFourBitmapControl : BTControl
    {
        protected SpecificControlProp m_SpecificProp = null;

        public BTDllFourBitmapControl()
        {
            m_IControl = new InteractiveFourBitmapDllControl();
            if (m_IControl != null)
                m_IControl.SourceBTControl = this;

            m_SpecificProp = new DllFourBitmapProp();
        }

        public BTDllFourBitmapControl(InteractiveControl Ctrl)
        {
            m_IControl = Ctrl;
            if (m_IControl != null)
                m_IControl.SourceBTControl = this;
        ...
        public override bool WriteOut(XmlDocument XmlDoc, XmlNode Node)
        {
            ...
            AttrDllId.Value = FourBitmap.DllEntryClass.DLL_Control_ID.ToString();

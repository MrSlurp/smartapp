...
namespace CtrlMailer
{
    ...
    public partial class InteractiveCtrlMailerDllControl : InteractiveControl, ISpecificControl
    {
        ...
        /// </summary>
        public InteractiveCtrlMailerDllControl()
        {
        ...
        {
            SizeF SizeText = gr.MeasureString("Mailer", SystemFonts.DefaultFont);
            PointF PtText = new PointF(ctrl.ClientRectangle.Left + 2, (ctrl.Height - SizeText.Height) / 2);
            gr.DrawString("Mailer", SystemFonts.DefaultFont, Brushes.Black, PtText);
        }

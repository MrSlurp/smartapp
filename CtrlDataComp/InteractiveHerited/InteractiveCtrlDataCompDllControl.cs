...
namespace CtrlDataComp
{
    ...
    public partial class InteractiveCtrlDataCompDllControl : InteractiveControl, ISpecificControl
    {
        ...
        /// </summary>
        public InteractiveCtrlDataCompDllControl()
        {
        ...
        {
            SizeF SizeText = gr.MeasureString("DataComp", SystemFonts.DefaultFont);
            PointF PtText = new PointF(ctrl.ClientRectangle.Left + 2, (ctrl.Height - SizeText.Height) / 2);
            gr.DrawString("DataComp", SystemFonts.DefaultFont, Brushes.Black, PtText);
        }
